...
<div id="logo-header" class="flex-stretch"><a href="index.php"><img class="logo" src="img/coolkeychains-logo.png" alt="CoolKeychains"></a></div>
	...
	<ul class= "nav-pills">
		...
		<li><a href="https://wbarrios.com/aau/wnm608/barrios.wilson/admin/index.php"><img class="icon" src="https://wbarrios.com/aau/wnm608/barrios.wilson/img/user.png" alt="user"></a></li>
