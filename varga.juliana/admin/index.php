...
<div class="itemlist-item display-flex">
	...
	<div class="flex-none display-flex">
		<div><a class="form-button-blue" href="admin/?id=$o->id">edit</a></div>
		<div><a class="form-button-blue" href="product_item.php?id=$o->id">visit</a></div>
	</div>
</div>
HTML;
}
