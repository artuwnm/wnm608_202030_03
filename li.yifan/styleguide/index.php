...
<head>
	...
	<style>
		h2 {
			margin-top: 6em;
			border-bottom: 1px solod var(--color-neutral-medium);
			margin-bottom: 1em;
		}
...
&lt;h6>Heading 6&lt;/h6>
		...
		<div class="card">
			...
			<hr>
			<!-- p*3>lorem20 -->
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse reprehenderit dolores, temporibus quidem animi consequuntur dolorem illum sit libero voluptatibus.</p>
			<p>Natus repellat dolorum, perspiciatis consequatur doloribus? Qui accusantium, consectetur illum necessitatibus eos asperiores aut quos id molestias, iste aperiam. Nostrum.</p>
			<p>Dicta voluptatum, similique pariatur asperiores dignissimos, nulla ducimus sapiente esse mollitia enim quos, necessitatibus! Fugiat facere, explicabo fugit quis voluptatum.</p>
	...
	<script>
		...
		// document.querySelectionAll('nav a').forEach(o=>{
			...
			<!-- <table class="table">
				...
				<tbody>
					<tr>
						<td>1</td>
						<td>522</td>
						<td>Hamilton Cline</td>
						<td>hcline@academyart.edu</td>
						<td>555-2424</td>
					</tr>
					<tr>
						<td>2</td>
						<td>512</td>
						<td>Fred McHale</td>
						<td>mcatanzaro@academyart.edu</td>
						<td>555-2424</td>
					</tr>
					<tr>
						<td>3</td>
					...
					<tr>
						<td>4</td>
						<td>514</td>
						<td>Andrea Pimentel</td>
						<td>apimentel@academyart.edu</td>
						<td>555-2424</td>
					</tr>
					<tr>
						<td>5</td>
						<td>516</td>
						<td>DC Scarpelli</td>
						<td>dscarpelli@academyart.edu</td>
						<td>555-2424</td>
					</tr>
				</tbody>
			</table> -->
	...
	<section class="container">
		...
		<div class="card">
			...
			<div class="form-control" style="padding: 0 5em;">
				<button type="button" class="form-button">EXPLORE THE LOOK</button>
			</div>
			<div class="form-control display-flex">
				<div class="flex-stretch"></div>
				<div class="flex-none" style="width: 33%;">
					<button type="button" class="buy form-button">EXPLORE MORE</button>
				</div>
			</div>
			<div class="display-flex">
				<button type="button" class="form-button">ADD TO CART</button>
				<button type="button" class="wish form-button">WISHLIST</button>
			</div>
			<!-- <div class="form-control">
	...
	<section class="container">
		...
		<div class="card">
			...
			<div>
				...
				<label>
					<input type="checkbox" id="check-example1">Checkbox
				</label>
			</div>
