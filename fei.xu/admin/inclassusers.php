...
<body>
	...
	<header class="navbar">
		<div class="container display-flex">
			...
			<nav class="nav-flex flex-none">
				<ul>
					<li><a href="admin/inclassusers.php">User List</a></li>
					<li><a href="admin/inclassusers.php?id=new">Add New User</a></li>
				</ul>
			</nav>
		</div>
	</header>
	...
	<div class="container">
			...
			foreach($users as $i=>$user) {
				echo "
				<li>
					<a href='admin/inclassusers.php?id=$i'>$user->name</a>
				</li>
				";
			}
